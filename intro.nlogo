...
cortarelvas-own [tdepth sight rotate]
globals [movimentos]
...
to find
  ...
  while [rotate < 4] [
    set sight 0
    rt 90
    while [[pcolor] of patch-ahead sight = green AND sight < world-height] [
      set sight sight + 1
    ]
    print(sight)
    if sight > world-height - 1 [set sight  0]
    set rotate rotate + 1
  ]
  ifelse sight != 0 [ fd sight - 1 ] [
      fd 1
      rt 90
      fd 1
    ]
